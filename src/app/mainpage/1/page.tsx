export default function Section1() {
  return (
    <section className="w-full bg-white flex flex-col items-center text-center px-6 py-10">
      ...
      <img src="/resources/icons/mainicon.jpeg" alt="Mascot" className="w-36 h-36 object-contain mb-4" />

      <button className="bg-[#a32424] text-white px-8 py-2 rounded-full font-semibold shadow hover:bg-[#8e1f1f] transition">
        START
      </button>
    </section>
  );

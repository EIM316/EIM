...
export default function TeacherRegisterPage() {
  ...
  useEffect(() => {
    ...
    fetch("/api/cloudinary/fetch2?folder=EIM/TEACHER")
      .then((res) => {
    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-white px-4 sm:px-6 md:px-10 py-10 relative">
      ...
      <div className="pt-20 flex flex-col items-center w-full">
        ...
        <p className="text-gray-600 font-medium mb-8 text-center text-sm sm:text-base">
          Create an account
          <br />
          <span className="font-normal">To Start Teaching and Guiding!</span>
        </p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-80 sm:w-[28rem] shadow-lg relative text-gray-700">
            ...
            <p className="text-sm leading-relaxed text-justify">
              This platform is designed for teachers to guide students in learning Electrical Installation
              and Maintenance (EIM) interactively. By using this app, you agree to uphold academic integrity
              and use the system only for educational purposes. Any misuse, unauthorized content sharing,
              or exploitation of data is strictly prohibited.
            </p>
            <button
      ...
      {showPrivacy && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 w-80 sm:w-[28rem] shadow-lg relative text-gray-700">
            ...
            <p className="text-sm leading-relaxed text-justify">
              We value your privacy. All teacher data such as name, ID number, and email are securely
              managed and used solely for authentication, tracking progress, and managing educational
              records. Your information will never be sold or shared with third parties and remains
              confidential under institutional data protection guidelines.
            </p>
            <button

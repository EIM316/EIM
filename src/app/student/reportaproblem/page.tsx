...
export default function ReportAProblemPage() {
  ...
  // ✅ Send report to unified API (saves + emails)
  ...
  return (
    <main className="min-h-screen flex flex-col items-center bg-white relative overflow-x-hidden">
      ...
      <div className="pt-24 flex flex-col items-center w-full px-6">
        <h1 className="text-2xl font-bold text-[#7b2020] mb-2">Report a Problem</h1>
        <p className="text-gray-600 mb-6 text-sm text-center max-w-md">
          If you encounter any issues or bugs while using the app, please describe
          them below. We’ll review your report as soon as possible.
        </p>

    ...
    <div className="min-h-screen bg-white flex flex-col items-center">
      ...
      <header className="w-full bg-[#548E28] text-white flex items-center justify-between px-5 py-3 shadow-md">
        <div className="flex items-center gap-3">
          <button onClick={() => router.push("/admin/gamemode")} className="hover:opacity-80 transition">
        ...
        <button onClick={() => { localStorage.clear(); router.push("/"); }} className="flex items-center gap-2 hover:opacity-80 transition">
